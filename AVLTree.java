...
public class AVLTree<E extends Comparable<E>> implements AVLTreeAPI<E> {
	 ...
	 * @param taller
	 *            indicates whether the subtree becomes taller after the
	 *            insertion
	 ...
	 * 
	 * @param curRoot
	 *            the node to be left-balanced
	 * @param taller
	 *            indicates whether the tree becomes taller
	...
	private Node leftBalance(Node curRoot, boolean[] taller) {
		...
		case EH: // This is an error
			...
			System.exit(1);
			break;
		case RH: // right-high - requires double rotation: first left, then
					// right
	 ...
	 * 
	 * @param node
	 *            the node at which the left-rotation occurs.
	 ...
	 * 
	 * @param node
	 *            the node at which the right-rotation occurs.
	 ...
	 * @param func
	 *            the function to be applied to the data in each node
	 */
	 ...
	 * @param shorter
	 *            indicates whether the subtree becomes shorter
	 * @param success
	 *            indicates whether the node was successfully deleted
